...
void TrebleClef::Init()
{
	//テクスチャ読み込み
	D3DX11CreateShaderResourceViewFromFile
	(
		Renderer::GetDevice(),
		"asset/texture/treble-clef.png",
		NULL,
		NULL,
		&Texture,
		NULL
	...
	position = { -40.0f,80.0f,0.0f };
	scale = { 190.0f,190.0f,0.0f };
}

void TrebleClef::Uninit()
{
...
void TrebleClef::Update()
{
}

void TrebleClef::Draw()
{
	//入力レイアウト設定
...
void TrebleClef::NextTrebleClef(int num)
{
